...
export const SET_DAILY_CALENDAR_MODE = "SET_DAILY_CALENDAR_MODE";
export const SET_WEEKLY_CALENDAR_MODE = "SET_WEEKLY_CALENDAR_MODE";

export const GO_PREV_DATE = "GO_PREV_DATE";
